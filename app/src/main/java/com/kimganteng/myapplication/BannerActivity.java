...
public class BannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout layAds = findViewById(R.id.lay300x250);
        RelativeLayout layNative = findViewById(R.id.lay320x50);
        AliendroidBanner.SmallBannerAdmob(this, layAds,Select_Backup_Ads,MainBanner,BackupBanner,""
                ,"","","","");
        ...
        AliendroidMediumBanner.MediumBannerAdmob(this, layNative,Select_Backup_Ads,MainBanner,BackupBanner,""
                ,"","","","");
